* Si è inteso un task come "`non completato`" se questo non è stato completato
  dopo circa novanta minuti di ricerca.

* Si è intesa una pagina come "`non raggiungibile`" se questa non è stata
  trovata entro circa novanta minuti. 
